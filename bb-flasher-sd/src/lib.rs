...
pub use customization::{Customization, RaspberryCustomCustomization, SysconfCustomization};
...
pub enum Error {
    ...
    RaspberryConfCreateFail {
        #[source]
        source: io::Error,
    },
    #[error("Failed to write {field} to custom.toml.")]
    RaspberryConfWriteFail {
        #[source]
        source: io::Error,
        field: &'static str,
    },
